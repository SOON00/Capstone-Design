...
from std_msgs.msg import Int32, Int16MultiArray, MultiArrayLayout,MultiArrayDimension
from rospy.numpy_msg import numpy_msg
...
if __name__ == '__main__':
    ...
    sub = rospy.Subscriber('/PWM',Int16MultiArray,msg_callback,queue_size=10)
    rospy.spin()
